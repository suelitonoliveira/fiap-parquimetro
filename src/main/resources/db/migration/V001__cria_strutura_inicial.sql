...
ALTER TABLE parquimetro.tb_sessao
    ADD CONSTRAINT FK_TB_SESSAO_ON_CONDUTOR FOREIGN KEY (condutor_id) REFERENCES parquimetro.tb_usuario (cod);

ALTER TABLE parquimetro.tb_sessao
    ADD CONSTRAINT FK_TB_SESSAO_ON_PARQUIMETRO FOREIGN KEY (parquimetro_id) REFERENCES parquimetro.tb_parquimetro (cod);
