...
ALTER TABLE parquimetro.tb_endereco
    ADD CONSTRAINT uc_tb_endereco_cod_usuario UNIQUE (cod_usuario);

ALTER TABLE parquimetro.tb_endereco
    ADD CONSTRAINT FK_TB_ENDERECO_ON_COD_USUARIO FOREIGN KEY (cod_usuario) REFERENCES parquimetro.tb_usuario (cod);
...
ALTER TABLE parquimetro.tb_veiculo
    ADD CONSTRAINT uc_tb_veiculo_placa UNIQUE (placa);
